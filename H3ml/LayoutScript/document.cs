...
namespace H3ml.Layout
{
    partial class document : IDocument
    {
        ...
        void IDocument.addEventListener(string @event, object function, bool useCapture)
        {
            throw new NotImplementedException();
        }

        INode IDocument.adoptNode(INode node)
        {
            throw new NotImplementedException();
        }
        ...
        INode IDocument.createAttribute(string attributename)
        {
            throw new NotImplementedException();
        }

        INode IDocument.createComment(string text)
        {
            throw new NotImplementedException();
        }
        ...
        IElement IDocument.createElement(string nodename)
        {
            throw new NotImplementedException();
        }
        ...
        INode IDocument.createTextNode(string text)
        {
            throw new NotImplementedException();
        }

        bool IDocument.execCommand(string command, bool showUI, object value)
        {
            throw new NotImplementedException();
        }

        bool IDocument.fullscreenEnabled()
        {
            throw new NotImplementedException();
        }
        ...
        NodeList IDocument.getElementsByClassName(string classname)
        {
            throw new NotImplementedException();
        }

        NodeList IDocument.getElementsByName(string name)
        {
            throw new NotImplementedException();
        }

        NodeList IDocument.getElementsByTagName(string tagname)
        {
            throw new NotImplementedException();
        }

        bool IDocument.hasFocus()
        {
            throw new NotImplementedException();
        }

        INode IDocument.importNode(INode node, bool deep)
        {
            throw new NotImplementedException();
        }

        void IDocument.normalize()
        {
            throw new NotImplementedException();
        }

        void IDocument.open(string MIMEtype, string replace)
        {
            throw new NotImplementedException();
        }

        IElement IDocument.querySelector(string selectors)
        {
            throw new NotImplementedException();
        }

        NodeList IDocument.querySelectorAll(string selectors)
        {
            throw new NotImplementedException();
        }

        void IDocument.removeEventListener(string @event, object function, bool useCapture)
        {
            throw new NotImplementedException();
        }

        INode IDocument.renameNode(INode node, string namespaceURI, string nodename)
        {
            throw new NotImplementedException();
        }

        void IDocument.write(params object[] args)
        {
            throw new NotImplementedException();
        }

        void IDocument.writeln(params object[] args)
        {
            throw new NotImplementedException();
        }
    }
