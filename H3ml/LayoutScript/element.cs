...
namespace H3ml.Layout
{
    partial class element : IElement
    {
        ...
        void IElement.addEventListener(string @event, object function, bool useCapture)
        {
            throw new NotImplementedException();
        }

        INode IElement.appendChild(INode node)
        {
            throw new NotImplementedException();
        }
        ...
        INode IElement.cloneNode(bool deep)
        {
            throw new NotImplementedException();
        }

        int IElement.compareDocumentPosition(INode node)
        {
            throw new NotImplementedException();
        }

        bool IElement.contains(INode node)
        {
            throw new NotImplementedException();
        }

        void IElement.exitFullscreen()
        {
            throw new NotImplementedException();
        }
        ...
        string IElement.getAttribute(string attributename)
        {
            throw new NotImplementedException();
        }

        IAttr IElement.getAttributeNode(string attributename)
        {
            throw new NotImplementedException();
        }

        IRect IElement.getBoundingClientRect()
        {
            throw new NotImplementedException();
        }

        NodeList IElement.getElementsByClassName(string classname)
        {
            throw new NotImplementedException();
        }

        NodeList IElement.getElementsByTagName(string tagname)
        {
            throw new NotImplementedException();
        }

        bool IElement.hasAttribute(string attributename)
        {
            throw new NotImplementedException();
        }

        bool IElement.hasAttributes()
        {
            throw new NotImplementedException();
        }

        bool IElement.hasChildNodes()
        {
            throw new NotImplementedException();
        }

        void IElement.insertAdjacentElement(string position, IElement element)
        {
            throw new NotImplementedException();
        }

        void IElement.insertAdjacentHTML(string position, string text)
        {
            throw new NotImplementedException();
        }

        void IElement.insertAdjacentText(string position, string text)
        {
            throw new NotImplementedException();
        }

        INode IElement.insertBefore(INode newnode, INode existingnode)
        {
            throw new NotImplementedException();
        }

        bool IElement.isDefaultNamespace(string namespaceURI)
        {
            throw new NotImplementedException();
        }

        bool IElement.isEqualNode(INode node)
        {
            throw new NotImplementedException();
        }

        bool IElement.isSameNode(INode node)
        {
            throw new NotImplementedException();
        }

        void IElement.normalize()
        {
            throw new NotImplementedException();
        }

        IElement IElement.querySelector(string selectors)
        {
            throw new NotImplementedException();
        }

        NodeList IElement.querySelectorAll(string selectors)
        {
            throw new NotImplementedException();
        }

        void IElement.removeAttribute(string attributename)
        {
            throw new NotImplementedException();
        }

        IAttr IElement.removeAttributeNode(IAttr attributenode)
        {
            throw new NotImplementedException();
        }

        INode IElement.removeChild(INode node)
        {
            throw new NotImplementedException();
        }

        void IElement.removeEventListener(string @event, object function, bool useCapture)
        {
            throw new NotImplementedException();
        }

        INode IElement.replaceChild(INode newnode, INode oldnode)
        {
            throw new NotImplementedException();
        }

        void IElement.requestFullscreen()
        {
            throw new NotImplementedException();
        }

        void IElement.scrollIntoView(bool? alignTo)
        {
            throw new NotImplementedException();
        }

        void IElement.setAttribute(string attributename, string attributevalue)
        {
            throw new NotImplementedException();
        }

        IAttr IElement.setAttributeNode(IAttr attributenode)
        {
            throw new NotImplementedException();
        }

        void IElement.toString()
        {
            throw new NotImplementedException();
        }
    }
