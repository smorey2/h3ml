...
namespace H3ml.Layout
{
    public class container_test : Icontainer
    {
        ...
        public void get_asset_size(string src, string baseurl, Dictionary<string, string> attributes, out size sz) { sz = default(size); }
        public void draw_asset(object hdc, asset_paint asset) { }
